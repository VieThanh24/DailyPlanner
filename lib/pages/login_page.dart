...
import 'package:kiem_tra_1/data/auth_data.dart';
import 'package:kiem_tra_1/pages/home_page.dart';

class LoginPage extends StatefulWidget {
  final VoidCallback show;
  LoginPage(this.show, {super.key});
  @override
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          if (isLoggedIn) {
            // Điều hướng đến trang Home_Screen sau khi đăng nhập thành công
            Navigator.of(context).pushReplacement(
              MaterialPageRoute(
                builder: (context) =>
                    Home_Screen(), // Thay bằng widget Home_Screen
              ),
            );
          } else {
